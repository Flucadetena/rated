...
CollectionReference refCollUserRankings(String userId) => refUser(userId).collection('rankings');
...
DocumentReference refUserRanking(String userId, String rankingId) => refCollUserRankings(userId).doc(rankingId);
...
Query refCollGroupRankingItems(String userId) =>
    _db.collectionGroup('ranking_items').where('userId', isEqualTo: userId);
